...
exports.cancel = exports.create = void 0;
...
(function (create) {
    ...
    create.path = function () { return "/v1/cash-receipts"; };
...
function cancel(connection, receiptKey, input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, PlainFetcher_1.PlainFetcher.fetch(__assign(__assign({}, connection), { headers: __assign(__assign({}, connection.headers), { "Content-Type": "application/json" }) }), __assign(__assign({}, cancel.METADATA), { path: cancel.path(receiptKey) }), input)];
        });
    });
}
...
(function (cancel) {
    ...
    cancel.path = function (receiptKey) {
        return "/v1/cash-receipts/".concat(encodeURIComponent(receiptKey !== null && receiptKey !== void 0 ? receiptKey : "null"), "/cancel");
    };
