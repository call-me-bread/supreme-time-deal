 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function webhook(connection: IConnection, input: ITossPaymentWebhook): Promise<void>;
export declare namespace webhook {
    type Input = ITossPaymentWebhook;
    const METADATA: {
...
export declare namespace deposit {
    ...
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/internal/:paymentKey/deposit";
