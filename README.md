...
# Domain Design Introduce

## Domain Design Overview 
<img width="1550px" src="docs/images/supreme-time-deal-domain-design.png">

## Accounts Domain Design
<img width="1000px" src="docs/images/account-flow.png">

## Product Domain Design
<img width="1000px" src="docs/images/product-flow.png">

## Order Domain Design
<img width="1000px" src="docs/images/order-flow.png">
