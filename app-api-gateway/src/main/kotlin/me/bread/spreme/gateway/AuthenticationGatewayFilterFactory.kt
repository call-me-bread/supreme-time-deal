package me.bread.spreme.gateway

import me.bread.spreme.gateway.dto.ValidateTokenRequestDTO
import me.bread.spreme.gateway.dto.ValidateTokenResponseDTO
...
class AuthenticationGatewayFilterFactory(
	...
	private fun validateToken(
		...
		val authorizationHeader =
			exchange.request.headers[HttpHeaders.AUTHORIZATION]?.get(0)
