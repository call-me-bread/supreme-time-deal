...
export declare namespace at {
    type Output = ITossPayment;
    const METADATA: {
        readonly method: "GET";
        readonly path: "/v1/payments/:paymentKey";
    ...
    const path: (paymentKey: string) => string;
}
/**
 * 카드로 결제하기.
 *
 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function key_in(connection: IConnection, input: ITossCardPayment.ICreate): Promise<key_in.Output>;
export declare namespace key_in {
    type Input = ITossCardPayment.ICreate;
    type Output = ITossCardPayment;
    const METADATA: {
        readonly method: "POST";
        readonly path: "/v1/payments/key-in";
        readonly request: {
            readonly type: "application/json";
            readonly encrypted: false;
        };
 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function approve(connection: IConnection, paymentKey: string, input: ITossPayment.IApproval): Promise<approve.Output>;
export declare namespace approve {
    type Input = ITossPayment.IApproval;
    type Output = ITossPayment;
    const METADATA: {
        readonly method: "POST";
        readonly path: "/v1/payments/:paymentKey";
 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function cancel(connection: IConnection, paymentKey: string, input: ITossPaymentCancel.ICreate): Promise<cancel.Output>;
export declare namespace cancel {
    type Input = ITossPaymentCancel.ICreate;
    type Output = ITossPayment;
    const METADATA: {
        readonly method: "POST";
        readonly path: "/v1/payments/:paymentKey/cancel";
        readonly request: {
            readonly type: "application/json";
            readonly encrypted: false;
        };
