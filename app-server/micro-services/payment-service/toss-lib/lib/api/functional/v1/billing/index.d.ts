 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function pay(connection: IConnection, billingKey: string, input: ITossBilling.IPaymentStore): Promise<pay.Output>;
export declare namespace pay {
    type Input = ITossBilling.IPaymentStore;
    type Output = ITossPayment;
    const METADATA: {
        readonly method: "POST";
        readonly path: "/v1/billing/:billingKey";
        readonly request: {
    ...
    const path: (billingKey: string) => string;
}
