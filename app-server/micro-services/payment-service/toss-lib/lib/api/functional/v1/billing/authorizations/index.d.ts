 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function at(connection: IConnection, billingKey: string, input: ITossBilling.ICustomerKey): Promise<at.Output>;
export declare namespace at {
    type Input = ITossBilling.ICustomerKey;
    type Output = ITossBilling;
    const METADATA: {
        readonly method: "POST";
        readonly path: "/v1/billing/authorizations/:billingKey";
        readonly request: {
